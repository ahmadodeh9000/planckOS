all:
	...
	i686-elf-gcc -m32 -ffreestanding -fno-stack-protector -fno-builtin -c src/keyboard.c -o keyboard.o
	
	i686-elf-ld -T link.ld -m elf_i386 -o kernel boot.o kernel.o vga.o gdt.o gdts.o idt.o idts.o util.o timer.o keyboard.o
